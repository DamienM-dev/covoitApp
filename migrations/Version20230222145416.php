 ...
 */
final class Version20230222145416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE brand (id INT AUTO_INCREMENT NOT NULL, brand VARCHAR(30) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, type_of_id INT DEFAULT NULL, immatriculation VARCHAR(255) NOT NULL, nbr_places INT NOT NULL, INDEX IDX_773DE69D5401248B (type_of_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, id_reservation_ride_id INT NOT NULL, reservation_from_id INT NOT NULL, created_at DATETIME NOT NULL, uptated_at DATETIME NOT NULL, INDEX IDX_42C849551155AD3E (id_reservation_ride_id), INDEX IDX_42C849551F5B628E (reservation_from_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, ride_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, login VARCHAR(20) NOT NULL, name VARCHAR(30) NOT NULL, surname VARCHAR(30) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649302A8A70 (ride_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE car ADD CONSTRAINT FK_773DE69D5401248B FOREIGN KEY (type_of_id) REFERENCES brand (id)');
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C849551F5B628E FOREIGN KEY (reservation_from_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car DROP FOREIGN KEY FK_773DE69D5401248B');
        ...
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C849551F5B628E');
